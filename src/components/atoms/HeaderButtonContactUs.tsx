...
const HeaderButtonContactUs: FC<HeaderButtonContactUsProps> = ({ className }) => {
    ...
    return (
        <a href="http://" target="_blank" rel="noopener noreferrer" aria-label="contact us" className={`relative inline-block px-6 py-3 text-blue-700 border-2 border-blue-700 transition-transform duration-500 ease-out group overflow-hidden rounded-full ${!scrolled && 'shadow-xl'} ${className}`}
        >
